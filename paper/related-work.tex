...
JSON is a common data-interchange format for exchanging data with webservices, but also for storing documents in noSQL databases, such as MongoDB\@.
...
Figure~\ref{json-schema-example} shows an example of a JSON schema and Listing~\ref{json-example} shows an example of a JSON document that conforms to the schema.

...
\begin{itemize}
    \item \textbf{RQ2.1}: Yes.
    Users are able to retrieving information by use of graphical user interface(GUI), tooltip of property or search function.
    \item \textbf{RQ2.2}: Yes.
    Users are able to modifying \cfgfiles{} within the constraints of a given schema.
    In some difficult situations, our tooltip function or error hints can help them resolve the problem.
    \item \textbf{RQ2.3}: Most of the users are able to modifying the schema file either on editor panel or GUI panel.
    Other users find that there are too many redundant properties in the GUI panel which make it hard to understand.
\end{itemize}

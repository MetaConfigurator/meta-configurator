...
Table~\ref{table:practical use} shows the individual opinions regarding practical use, their thoughts on the fields in which this tool could be used and the target users for using this tool.

\begin{table*}   %keyuri

    \centering
    \caption{Use in Practice} \label{table:practical use}

...
Tables~\ref{table:user_study1}-\ref{table:user_study5} show the feedback of the interviewees, as well as which measures we took based on it.
...
\begin{table*}  %keyuri
    \centering
    \caption{User Study 3 - Feedback and Resolution} \label{table:user_study3}
    \begin{tabular}{p{0.45\linewidth}p{0.45\linewidth}}
        \toprule
        \thead{Feedback} & \thead{Resolution} \\
        \midrule
...
\begin{table*}   %keyuri
    \centering
    \caption{User Study 4 - Feedback and Resolution} \label{table:user_study4}
    \begin{tabular}{p{0.45\linewidth}p{0.45\linewidth}}
        \toprule
        \thead{Feedback} & \thead{Resolution} \\
        \midrule
...
\begin{table*}   %keyuri
    ...
    \centering
    \caption{User Study 5 - Feedback and Resolution} \label{table:user_study5}
    \begin{tabular}{p{0.45\linewidth}p{0.45\linewidth}}
        \toprule
        \thead{Feedback} & \thead{Resolution} \\
        \midrule
...
Table~\ref{table:results} shows the individual opinions regarding practical use, their thoughts on the fields in which this tool could be used and the target users for using this tool.

\begin{table*}   %keyuri

    \centering
    \caption{Use in Practice} \label{table:user's opinion about use of tool}
    \begin{tabular}{p{0.3\linewidth}p{0.3\linewidth}p{0.3\linewidth}}
        \toprule
        \thead{} &
        \thead{Work Field / Profession} & \thead{Opinion regarding Practical Use} \\
        \midrule
        User Study 1 & Professor &
        Once the schema is loaded then one can start easily and after doing one time use, it will be easy to understand the 3 views. \\
        \midrule
        User Study 2 & Professor & This tool will be recommended, and some project partners who require schema modification and extension will be invited. \\
        \midrule
        User Study 3 & Software engineer &
        This tool is helpful to many people, such as scientists involved in data organization in the fields of chemistry and biology, rather than using Excel. It will be recommended to software engineers managing CI pipelines. It can also be used in the research field and promoted to partners for their use and sale of this tool. \\
        \midrule
        User Study 4 & Professor &
        Will be use this tool with own schema.
        It is useful even for those who have limited knowledge or understanding of schemas. \\
        \midrule
        User Study 5 & Student &
        Computer science People as well non computer science People can use this tool only by loading JSON schema and do modification.\\ \bottomrule

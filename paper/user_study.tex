...
\begin{table*}
    ...
    \begin{tabular}{p{0.45\linewidth}p{0.45\linewidth}}
        ...
        &
        We replace the numerical labels by a standard programming notation, which is \texttt{propertyName[0]}, \texttt{propertyName[1]}, \ldots
        \\
        \midrule
...
\begin{table*}
    ...
    \begin{tabular}{p{0.45\linewidth}p{0.45\linewidth}}
        ...
        \midrule
        Simply the schema editor to make it easier to work with, for those who are not very familiar with JSON schema.
        &

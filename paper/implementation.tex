...
\begin{figure*}
    ...
    \caption{UI of File Editor view. Different components highlighted in red: 1) button to switch to other view (e.g. to Schema Editor view), 2) Toolbar with various functionality, 3) Code Editor panel, 4) GUI Editor panel}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=2.5in]{figures/Tooltip_example.png}
    \caption{Tool-tip}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=2.5in]{figures/schema_violation.png}
    \caption{Tool-tip with schema violation}

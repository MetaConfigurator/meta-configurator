...
\subsubsection{Toolbar functionalities} %keyuri
...
% todo: show how corresponding GUI components look like for string, number, int, array, object, boolean, enum (const would be enum with just Minyeone option)

\paragraph{Components for other JSON Schema features}

% TODO: show how corresponding GUI components look like for required, deprecated, oneOf, anyOf Minye

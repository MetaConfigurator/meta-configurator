...
\begin{table*}
    \centering
    \caption{Settings view functionality\label{tab:settings}}
    \begin{tabular}{@{}p{0.3\linewidth}p{0.6\linewidth}@{}}
        \toprule
        \textbf{Configuration} & \textbf{\ Description} \\
        \midrule
        Data Format & Users can select between JSON and YAML data format. The choice made here will influence all three views.  \\
        Gui Editor On Right Side & By default, the GUI panel is located on the right side, but users have the flexibility to change it to the left side using this option.  \\
        Code Editor Font Size & Customize the \textbf{font size} in the code editor panel to suit user's preferences. \\
        GUI Editor Configuration & Users can configure the property sorting in the GUI editor, including options like:
        \begin{itemize}
        ...
        \end{itemize}
        And \textbf{maximum depth} determines the maximum level of nesting or hierarchy displayed in the GUI editor. \\

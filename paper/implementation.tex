...
The code editor is a text editor program designed for editing source code of computer programs. In our user case, we use the very popular and strong editor called  \textbf{Ace Editor}. \ref{Ace-Editor} It is a browser based editor that matches and extends the features, usability and performance of existing native editors such as TextMate, Vim or Eclipse. It can be easily embedded in any web page or JavaScript application.

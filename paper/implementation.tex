...
The File Editor view (1) has been primarily designed to facilitate the creation and editing of configuration files. This view is equipped with a user-friendly top menu bar (2) that offers a range of essential functionalities.
\begin{figure}[h]
    \includegraphics[width=3.5 in]{figures/fileeditor}
    \caption{FileEditor}
...
In the context of the figure, the Schema Editor view (1) empowers users to define and manage schema templates for configuration files. This view plays a crucial role in maintaining consistency and structure within your configurations.
\begin{figure}[h]
    \includegraphics[width=3.5 in]{figures/schemaeditor}
...
\subsection{Workflow}\label{subsec:workflow} User Guide used can be found in the wiki of our GitHub repository %todo
In this section, we outline the workflow of our tool.

\begin{enumerate}
    \item Users can open our tool ConfigAssistant. % todo link

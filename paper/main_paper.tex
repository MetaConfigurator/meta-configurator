...
First, we evaluated existing schema languages by expressiveness and popularity and chose JSON schema as the most suitable for this work.
...
We conducted a user study with three professors and two researchers, where they had to solve particular tasks using the tool and then provide feedback about it.
All five participants provided useful suggestions for improving the tool, which we then incorporated into the tool.

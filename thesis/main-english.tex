...
% Define a reusable style for code listings
\lstdefinestyle{json}{
    basicstyle=\ttfamily\scriptsize,  % monospaced and smaller
...
\definecolor{xmltagcolor}{RGB}{0, 100, 180}      % blue for tag names
\definecolor{xmlattrcolor}{RGB}{180, 60, 0}      % orange-red for attribute names
\definecolor{xmlvaluecolor}{RGB}{0, 140, 60}     % green for attribute values
\definecolor{xmlcommentcolor}{RGB}{140, 140, 140}% grey for comments
\definecolor{xmlcontentcolor}{RGB}{80, 0, 120}   % purple for text content
\definecolor{backcolour}{RGB}{245, 245, 250}     % light background

\lstdefinelanguage{xmlcolored}{
    sensitive=true,
    morestring=[b]",
    morestring=[b]',
    morecomment=[s]{<!--}{-->},
    moredelim=[s][\color{xmltagcolor}\bfseries]{<}{\ },     % tag names before space
    moredelim=[s][\color{xmltagcolor}\bfseries]{</}{>},     % closing tags
    moredelim=[s][\color{xmltagcolor}\bfseries]{<}{>},      % self-closing / simple tags
    moredelim=[l][\color{xmltagcolor}\bfseries]{/>},        % self-closing end
}
...
\lstdefinestyle{xml}{
    ...
    frame=single,
    backgroundcolor=\color{backcolour},
    stringstyle=\color{xmlvaluecolor}\ttfamily,      % attribute values in green
    commentstyle=\color{xmlcommentcolor}\itshape,    % comments in grey italic
    keywordstyle=\color{xmlattrcolor}\ttfamily,      % attribute names in orange-red
    identifierstyle=\color{xmlcontentcolor},         % text content in purple
    literate=
        {=}{{\color{xmlattrcolor}=}}1                % colour the = in attributes
        {<}{{\color{xmltagcolor}<}}1                 % colour angle brackets
        {>}{{\color{xmltagcolor}>}}1
        {/}{{\color{xmltagcolor}/}}1,
}
...
\lstdefinestyle{turtle}{
    ...
    frame=single,
    backgroundcolor=\color{backcolour},
    stringstyle=\ttfamily,       % literals
    commentstyle=\ttfamily\itshape, % comments italic
    keywordstyle=\ttfamily,      % RDF keywords like a:, rdfs:, etc.
    morekeywords={@prefix,@base}, % Turtle directives
    alsoletter={:,_},            % allow colon and underscore in keywords
    literate=
      {:}{{:}}1
      {;}{{;}}1
      {,}{{,}}1
...
\lstdefinestyle{sparql}{
    ...
    morekeywords={
        ...
        UNION, PREFIX, BASE, GRAPH, FROM, ORDER, BY, DESC, ASC, LIMIT, OFFSET
    },
    alsoletter={:,_},
    literate=
      {:}{{:}}1
...
\renewcommand*{\glossaryheader}{%
  \toprule
  \textbf{Notation} & \textbf{Description} & \textbf{Page List} \\
  \midrule
  \endhead
}
...
% Chapters
\input{chapters/01_background_and_related_work.tex}
\input{chapters/02_design_and_implementation.tex}
\input{chapters/03_application.tex}
\input{chapters/04_conclusion_and_outlook.tex}

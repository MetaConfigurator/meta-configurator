...
% Unified color palette for all lstlisting styles
\definecolor{lstBackground}{RGB}{245,245,250}
\definecolor{lstNumber}{RGB}{0,0,0}
\definecolor{lstKeyword}{RGB}{0,0,0}
\definecolor{lstString}{RGB}{0,0,0}
\definecolor{lstComment}{RGB}{0,0,0}
\definecolor{lstIdentifier}{RGB}{0,0,0}
\definecolor{lstPunctuation}{RGB}{0,0,0}

% Legacy aliases used by older listing definitions
\definecolor{eclipseStrings}{RGB}{0,0,0}
\definecolor{eclipseKeywords}{RGB}{0,0,0}
\colorlet{numb}{lstNumber}
...
\lstset{
  ...
  %
  commentstyle=\color{lstComment}\slshape,
  %
  % default: \rmfamily
  stringstyle=\color{lstString}\ttfamily,
  %
...
\lstdefinestyle{json}{
    ...
    stringstyle=\color{lstString}\ttfamily,
    commentstyle=\color{lstComment}\ttfamily\itshape,
    keywordstyle=\color{lstKeyword}\ttfamily,
...
\lstdefinelanguage{xmlcolored}{
    ...
    morestring=[b]',
    morecomment=[s]{<!--}{-->},
    moredelim=[s][\color{lstKeyword}\bfseries]{<}{\ },     % tag names before space
    moredelim=[s][\color{lstKeyword}\bfseries]{</}{>},     % closing tags
    moredelim=[s][\color{lstKeyword}\bfseries]{<}{>},      % self-closing / simple tags
    moredelim=[l][\color{lstKeyword}\bfseries]{/>},        % self-closing end
}
...
\lstdefinestyle{plaintext}{
    basicstyle=\ttfamily\small\color{lstPunctuation},
    numbers=none,
    showstringspaces=false,
    breaklines=true,
    frame=single,
    ...
    language={},
    moredelim=[s][\color{lstPunctuation}]{0}{9},
}
...
\lstdefinestyle{sparql}{
    ...
    stringstyle=\color{lstString}\ttfamily,
    commentstyle=\color{lstComment}\ttfamily\itshape,
    keywordstyle=\color{lstKeyword}\ttfamily\bfseries,
    identifierstyle=\color{lstIdentifier},
    morekeywords={
...
\input{chapters/05_use_of_ai}
\input{chapters/06_code_and_data}

...
\lstdefinestyle{plaintext}{
    basicstyle=\ttfamily\scriptsize, % monospaced, small font
    numbers=left,                     % line numbers
    numberstyle=\tiny,                % size of line numbers
    stepnumber=1,
    numbersep=5pt,
    showstringspaces=false,           % don't show spaces as special symbols
    breaklines=true,                  % wrap long lines
    frame=single,                     % box around the listing
    backgroundcolor=\color{backcolour}, % light background
    stringstyle=\ttfamily,            % plain text for strings
    commentstyle=\ttfamily,           % plain text for comments
    keywordstyle=\ttfamily,           % no keyword highlighting
    morekeywords={}                   % no extra keywords
}

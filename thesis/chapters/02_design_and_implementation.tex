...
\begin{lstlisting}[float=htbp,style=plaintext,caption={Sample RML hints which describe the mapping from JSON in \ref{lst:background_json_example} to JSON-LD in \ref{lst:background_jsonld_example}}, label={lst:metaconfigurator_interface_rdf:rml_hint}]

...
Listing~\ref{lst:background_sparql_example} presents a SPARQL example using the \gls{jsonld} simulation data, where all experiment parameters and metrics are retrieved together with their corresponding values and units.

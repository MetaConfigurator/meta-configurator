...
const programmingLanguageChoices = ref([
    "python", "java", "typescript", "swift", "kotlin", "rust", "dart", "go", "csharp", "c++"
])
...
<template>
  <Dialog v-model:visible="showDialog" header="Generate Source Code" :style="{ maxWidth: '90%', minWidth: '60%', margin: 'auto' }">
    <div class="flex flex-wrap justify-content-center gap-3 bigger-dialog-content">

      <Select v-model="selectedProgrammingLanguage" :options="programmingLanguageChoices" placeholder="Select a programming language" class="w-1/2"/>

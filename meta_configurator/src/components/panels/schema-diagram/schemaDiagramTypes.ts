...
export function schemaGraphToVueFlowEdges(
  graph: SchemaGraph,
  individualAttributeHandles: boolean
): Edge[] {
...
export function schemaGraphToVueFlowGraph(
  graph: SchemaGraph,
  individualAttributeEdges: boolean = true
): VueFlowGraph {

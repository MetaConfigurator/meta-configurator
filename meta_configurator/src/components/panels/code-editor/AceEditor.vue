...
const featuresDisabledForPerformance = computed(() => {
  ...
  return editorContentSize > performanceSettings.maxDocumentSizeForValidation || editorContentSize > performanceSettings.maxDocumentSizeForCursorSynchronization;
});
...
<template>
  ...
  >Some editor features are disabled for performance reasons due to the large size of the document.</Message
  >

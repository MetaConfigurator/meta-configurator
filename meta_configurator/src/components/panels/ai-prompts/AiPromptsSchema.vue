    ...
    <div class="p-5 space-y-3">
      ...
      <div class="flex flex-col space-y-4" v-else>
        <span>
          ...
          <Button
            ...
            size="small"
            v-tooltip="
              'When the complete schema is selected for modification, the complete schema will be processed by the AI to apply the modification. If you want a modification only for a specific class or attribute type, selecting that element will help reduce the processing time for the modification and increase the quality of the result. Especially for large schemas, it is not recommended to use the complete schema document for generating modifications.'
            ">
      ...
      <div v-show="newDocument.length > 0">
        ...
        <Message severity="error"
          >Generated Schema is not valid JSON. Please fix the errors before applying the
          schema.</Message
        >

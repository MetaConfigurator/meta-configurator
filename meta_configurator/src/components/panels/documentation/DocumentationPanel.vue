...
import {findBestMatchingData, findBestMatchingNodeData} from '@/schema/graph-representation/graphUtils';
...
const schemaGraph = computed(() => constructSchemaGraph(schemaPreprocessed.value, useSettings().value.documentation.mergeAllOfs));
const markdown = computed(() =>
  schemaToMarkdown(schemaPreprocessed.value, getSchemaTitle(schema.schemaWrapper.value), schemaGraph.value)
);

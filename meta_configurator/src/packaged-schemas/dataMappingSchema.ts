...
export const DATA_MAPPING_SCHEMA: TopLevelSchema = {
    ...
    properties: {
        mappings: {
            title: "Mappings from source instance to target instance. Any mappings that are not specified here will be ignored and the corresponding values from the source document will not be ported over to the target document",
            type: "array",
            items: {
                type: "object",
                properties: {
        ...
        transformations: {
            ...
            description: "Transformations to apply to the source data before mapping. Each transformation will be applied to the source data before the mapping is performed. The transformations are applied in the order they are specified in this array.",
            items: {
                type: "object",
                properties: {
                    operationType: {

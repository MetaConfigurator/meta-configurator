    ...
    schemaSelectionLists: {
          ...
          items: {
            ...
            properties: {
              ...
              schemas: {
                type: ["string", "array"],
                description: 'List of schemas to select from. Each schema has a title and a URL to load it from. Either provide a URL to a JSON file containing an array of such schema entries, or provide the array directly.',
                oneOf: [
                  {
                    type: 'string',
                    title: 'URL to Schema Selection List',
                    description:
                      'A URL to a JSON file containing an array of schema entries.',
                    format: 'uri',
                  },
                  {
                    type: 'array',

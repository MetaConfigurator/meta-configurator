...
export function extractSourcePaths(config: DataMappingConfig): string[] {
    ...
    const uniqueSourcePaths = Array.from(new Set(usedSourcePathsMapping.concat(usedSourcePathsTransformations)));
...
export function extractInvalidSourcePathsFromConfig(config: DataMappingConfig, inputData: any): string[] {

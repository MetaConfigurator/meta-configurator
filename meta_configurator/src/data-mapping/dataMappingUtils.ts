...
export function pathToNormalizedJsonPointer(path: Path, replaceIndexByPlaceholder: boolean): string {
    let resultPath = path;
...
export function normalizeJsonPointer(jsonPointer: string, replaceIndexByPlaceholder: boolean): string {
